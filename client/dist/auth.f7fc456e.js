...
})({"7sUBo":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7446f289f7fc456e";
"use strict";
...
},{}],"g8exC":[function(require,module,exports) {
...
/* Хранение данных об пользователе ====================================================================== */ const SET_USER = "SET_USER";
const LOGOUT = "LOGOUT";
const defaultState = {
    currentUser: {},
    isAuth: false
};
function useReducer(state = defaultState, action) {
    switch(action.type){
        case SET_USER:
            return {
                ...state,
...
const registration = async ()=>{
    ...
    try {
        const response = await (0, _axiosDefault.default).post(`http://localhost:5000/api/auth/registration/`, {
            email,
            password
        });
...
const login = async ()=>{
    ...
    try {
        const response = await (0, _axiosDefault.default).post(`http://localhost:5000/api/auth/login/`, {
            email,
            password
        });
...
const authorization = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get(`http://localhost:5000/api/auth/auth/`, {
            headers: {
...
* (добавляла класс active) */ function setLocation(curLoc) {
    try {
...
var Buffer = require("a8124e5e00ecd86").Buffer;
"use strict";
/**
...
},{"a8124e5e00ecd86":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("47731c19342743c2");
var ieee754 = require("6b562e020b45d909");
...
},{"47731c19342743c2":"eIiSV","6b562e020b45d909":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7sUBo"], null, "parcelRequire30ab")

//# sourceMappingURL=auth.f7fc456e.js.map
